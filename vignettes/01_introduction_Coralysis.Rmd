---
title: "Coralysis: sensitive cell population identification through multi-level integration of single-cell data"
...
clt.plot <- ClusteringScatterPlot(pbmc_10Xassays, dim.reduction.type = "tsne", return.plot = TRUE, 
                                  point.size = 0.01, show.legend = FALSE, title = "Coralysis clusters")
...
# start <- Sys.time()
set.seed(1024)
map <- ReferenceMapping(ref = ref, query = query, ref.label = "cell_type", project.umap = TRUE)
# stop <- Sys.time()
